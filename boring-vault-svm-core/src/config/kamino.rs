...
impl KaminoConfig {
    pub fn new(
        ...
        let lend_config: KaminoLendStrategyConfig =
            serde_json::from_value(all_data[lend_strategy_profile_key].clone()).map_err(|e| {
                eyre::eyre!(
        ...
        let borrow_config: KaminoBorrowStrategyConfig =
            serde_json::from_value(all_data[borrow_strategy_profile_key].clone()).map_err(|e| {
                eyre::eyre!(
